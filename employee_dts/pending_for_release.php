                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                $res = mysqli_query($conn,"select * from documents where DocumentID IN (select document_id from doc_emp_relationship where employee_id = ".$_SESSION['employeeid'].") and status = 'Pending' and FileLocation ='0';" );
                                $tmp = 1;
